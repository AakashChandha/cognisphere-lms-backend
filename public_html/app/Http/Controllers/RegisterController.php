    ...
    */
    ...
    public function login(Request $request)
    {
        ...
        { 
            ...
            {
                //$request->session()->regenerate();
                return redirect()->intended('/instructors');
            } else {
                //$request->session()->regenerate();
                return redirect()->intended('/learner');
            }
            ...
            return redirect()->back()->with('error', 'Please enter valid Username and Passsword');
    ...
    public function verify($id,$verifyId)
    {
        ...
        elseif($verifyId == 1)
        {
            ...
            try {
                ...
                return redirect()->back()->with('error', 'Verification email not sent!, Try Again');
            }
